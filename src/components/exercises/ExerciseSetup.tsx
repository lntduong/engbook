    ...
    const fetchOptions = async () => {
        ...
        try {
            if (type === 'VOCABULARY') {
                ...
                // Fetch levels for grammar
                const res = await fetch('/api/grammar/options');
                const data = await res.json();
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectItem value="ALL">All {type === 'VOCABULARY' ? 'Lessons' : 'Levels'}</SelectItem>
                            {options.map((opt) => (
